      ...
      <section className="gridBox">
        <Grid container justifyContent="center" spacing={2}>
          ...
          <Paper className="paper" onClick={handlepaperclick}>
                <img className="imgStory" src='https://thumbor.forbes.com/thumbor/trim/0x53:980x604/fit-in/711x399/smart/https://specials-images.forbesimg.com/imageserve/60834c47698b7d2cd708c3f0/0x0.jpg' alt="" />
              </Paper>
              <Paper className="paper" onClick={handlepaperclick}>
                <img className="imgStory"  src='https://cdn.mos.cms.futurecdn.net/68nJwaxHSFmE6whdL4r5oH-970-80.jpg.webp' alt="" />
              </Paper>
              <Paper  className="paper" onClick={handlepaperclick}>
                <img className="imgStory" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnG0NLa59PE1ZVQeqq4ZJkkkhuibDTG2hHYg&usqp=CAU" alt="" />
              </Paper>
              <Paper className="paper" onClick={handlepaperclick}>
                <img className="imgStory" src="https://media.geeksforgeeks.org/wp-content/cdn-uploads/20191101175718/How-do-I-become-a-good-Java-programmer.png" alt="" />
              </Paper>
        </Grid>
      </section>
